...
public class AccountTest {
    ...
    public void testCreateQRCodeTicket() {
        Result<QRCode> result = accountExtService.createQRCodeTicket(TOKEN, null, "QR_LIMIT_SCENE", 123, null);
    ...
    public void testGetQRCodeByTicket() {
        ...
        Result result = accountExtService.getQRCodeByTicket("gQHQ7zwAAAAAAAAAAS5odHRwOi8vd2VpeGluLnFxLmNvbS9xLzAybUd3d2NWamw5TlQxMDAwMHcwM2EAAgR7NRZbAwQAAAAA", file);
        System.out.println("--->"+result);
    }

    @Test
    public void testLongToShort() {
        Result result = accountExtService.longToShort(TOKEN, "http://yzcrm.test.111.com.cn/h5v2/index.html#/?userId=1&userName=admin&userRole=2,4,6&platformId=6&currentTime=1528162199023&md5msg=1admin2,4,661528162199023&token=aa551c71f0cea1b7241b36c1987518ea");
        System.out.println("--->"+result);
    }
}
