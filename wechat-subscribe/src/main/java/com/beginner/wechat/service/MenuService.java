...
public interface MenuService {
     ...
     * @see <a href="https://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1421141014">微信接口文档</a>
     * @param accessToken 微信access_token
     * @return 微信返回结果
     */
     ...
     * @see <a href="https://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1421141015">微信接口文档</a>
     * @param accessToken 微信access_token
     * @return 微信返回结果
     */
    ...
    /**
     * 创建个性化菜单<br/>
     * 出于安全考虑，一个公众号的所有个性化菜单，最多只能设置为跳转到3个域名下的链接。<br/>
     * 创建个性化菜单之前必须先创建默认菜单（默认菜单是指使用普通自定义菜单创建接口创建的菜单）。如果删除默认菜单，个性化菜单也会全部删除。<br/>
     * 个性化菜单接口支持用户标签，请开发者注意，当用户身上的标签超过1个时，以最后打上的标签为匹配。
     * @see <a href="https://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1455782296">微信接口文档</a>
     * @param accessToken 微信access_token
     ...
     * @see <a href="https://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1434698695">微信接口文档</a>
     * @param accessToken 微信access_token
     * @return 自定义菜单配置
     */
