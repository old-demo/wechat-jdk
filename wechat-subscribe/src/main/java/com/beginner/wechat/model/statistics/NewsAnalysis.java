...
public class NewsAnalysis {
    ...
    /**
     * statDate 统计的日期，在getarticletotal接口中，ref_date指的是文章群发出日期， 而stat_date是数据统计日期
     */
    ...
    /**
     * intPageReadUser 图文页（点击群发图文卡片进入的页面）的阅读人数
     */
    ...
    /**
     * shareScene 分享的场景 1代表好友转发 2代表朋友圈 3代表腾讯微博 255代表其他
     */
    ...
    /**
     * targetUer 送达人数，一般约等于总粉丝数（需排除黑名单或其他异常情况下无法收到消息的粉丝）
     */
    @JSONField(name = "target_user")
    private String targetUer;

    /**
     * userSource 在获取图文阅读分时数据时才有该字段，代表用户从哪里进入来阅读该图文。
