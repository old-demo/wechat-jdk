...
public class NewsDetails {
    ...
    /**
     * targetUser 送达人数，一般约等于总粉丝数（需排除黑名单或其他异常情况下无法收到消息的粉丝）
     */
    ...
    /**
     * intPageFromFriendsReadCount 其他场景阅读人数
     */
